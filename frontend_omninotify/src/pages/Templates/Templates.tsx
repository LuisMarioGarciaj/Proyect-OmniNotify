...
const TemplatesPage: React.FC = () => {
  ...
  const handleUpdateTemplate = async (templateData: any) => {
    ...
    try {
      await axios.put(
        `${API_BASE_URL}/templates/${selectedTemplate.id}/company/${selectedTemplate.company_id}`,
        templateData
      );
  ...
  const handleDeleteTemplate = async () => {
    ...
    try {
      await axios.delete(
        `${API_BASE_URL}/templates/${templateToDelete.id}/company/${templateToDelete.company_id}`
      );
