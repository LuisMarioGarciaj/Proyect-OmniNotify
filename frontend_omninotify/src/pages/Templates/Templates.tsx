...
const TemplatesPage: React.FC = () => {
  ...
  const loadTemplates = async () => {
    ...
    try {
      ...
      // GET /templates/company/:companyId - ✅ CORRECTO
  ...
  const handleUpdateTemplate = async (templateData: any) => {
    ...
    try {
      ...
      // ✅ CORREGIDO: PUT /templates/:id (sin /company/:companyId)
  ...
  const handleDeleteTemplate = async () => {
    ...
    try {
      ...
      // ✅ CORREGIDO: DELETE /templates/:id (sin /company/:companyId)
